...
const Header = () => {
    return (
        <div className="bg-yellow-100 p-5 flex justify-between flex-wrap">
           ...
           <Link href="pizzas/basket">
                
                    <div className="bg-transparent rounded-full p-4 w-30 h-30">
                        <ShoppingBasket />
                </div>
                <span className="absolute  top-3 right-2 text-[13px] bg-red-600 h-[18px] w-[18px] rounded-full grid place-items-center text-white">0</span>
